...
|CPY_TITLE|Copy title data (.tmd + .app), rewriting destination|source full path name (directory name ending with '/' forces to seek for the latest version); destination full path name|
