...
```JSON
{
  ...
  "menu":{ top menu hierarchy tag, binds by name to gui.json
    ...
    "selcolor":"ff000000", selected menu item color pair (default - black on white)
    "disabled":"ff7f7f7f", not available menu item text color (default - grey on transparent)
    "unselected":"ff7f7f7f", selected not available menu item color pair (default - grey on white)
